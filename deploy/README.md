...
after their architecture decisions. Production namespace, domain, certificate
issuer, and storage class have unconfigured Helm/Terraform entry points under
[`contracts/`](contracts/README.md); their values remain `TBD-019`. Cloud
provider and Secret Manager selections also remain TBD.
